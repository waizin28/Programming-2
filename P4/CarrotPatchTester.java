...
/**
 * Tester class for Carrot Patch methods
 * 
 * @author waizin
 *
 */
public class CarrotPatchTester extends CarrotPatch {
  ...
  public static boolean test2isCloseMethod() {
    ...
    Wolf w1 = new Wolf();
    Wolf w2 = new Wolf();
    // Set first Wolf at position(700,300)
    w1.setX(700);
    w1.setY(300);
    // Set second Wolf at position(300,300)
    w2.setX(300); // Wolf is 400px away from another wolf
    w2.setY(300);
    // checking for range of two wolves
  ...
  public static boolean test3isCloseMethod() {
    ...
    // Set first Rabbit at position(700,300)
    r1.setX(400);
    r1.setY(200);
    // Set second Rabbit at position(300,300)
    r2.setX(200); // Rabbit is 200px away from another rabbit
    r2.setY(200);
    // checking for range of two rabbits
    if (r1.isClose(r2.getX(), r2.getY(), Rabbit.getScanRange())) { // bug! isClose() should return
                                                                   // false here
      System.out.println(
          "Problem detected: Rabbit.isClose2() returned true when it should return false.");
      return false;
    }
